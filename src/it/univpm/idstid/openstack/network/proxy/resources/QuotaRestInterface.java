...
public class QuotaRestInterface {
	...
	public Quota showQuota(@PathParam("tenantId") String tenantId) throws MalformedURLException{
		JSONObject json=HTTPConnector.getJsonResponse(new URL(this.URLpath+tenantId), OpenstackNetProxyConstants.HTTP_METHOD_GET, OpenstackNetProxyConstants.TYPE_JSON);
